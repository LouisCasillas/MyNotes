...
## Notes
 ...
 - macros
	...
	- :reg
		- view the registers which store clipboards and the macros
 ...
 - search and replace
	...
	- :help perl-patterns
		- compare differences between perl regex and vim regex
	- :help magic
 ...
 - message redirection
	- Note: For some reason :reg will not show the last register used by redir
 	- :help redir
 	- :redir > <filename>
	- :redir =><variable>
 	- :redir @<a-zA-Z>
